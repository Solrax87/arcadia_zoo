<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if(empty($erreur)) {
            ...
            $query = " INSERT INTO rapports (veterinaire_id, date, animal_id, habitat_id, etat, nourriture, grammage, commentaire ) 
            VALUES ('$veterinaire_id', '$date', '$animal_id', '$habitat_id', '$etat', '$nourriture', '$grammage', '$commentaire' )";
...
?>
    ...
    <section class="container">
        ...
        <div class="formeLine rounded mt-4 shadow p-3 mb-5">
                <form method="POST" action="/admin/form/new_rapport.php">
